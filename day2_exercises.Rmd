...
for(year in unique(gapminder$year)){
  corr = cor(log(gapminder$gdpPercap)[gapminder$year == year], log(gapminder$lifeExp)[gapminder$year == year])
  print(paste("The correlation for year", year, "is", corr))
}
```

Yes. The relationship between GDP per capita and life expectancy changes over time. 
...
```{r}
for(conti in unique(gapminder$continent)){
  corr = cor(log(gapminder$gdpPercap)[gapminder$continent == conti], log(gapminder$lifeExp)[gapminder$continent == conti])
  print(paste("The correlation for continent", conti, "is", corr))
}


```

Yes. The relationship between GDP per capita and life expectancy varies by continent. 
